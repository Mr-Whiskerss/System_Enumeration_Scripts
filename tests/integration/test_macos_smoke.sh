...
# Basic smoke test for MacOS_Basic_Enumerator_V1.1.sh
...
echo "[TEST] MacOS Basic Enumerator - Smoke Test"
echo "==========================================="

# Cleanup function
cleanup() {
    # Kill any caffeinate processes started by the test
...
if [ $EXIT_CODE -eq 0 ] || [ $EXIT_CODE -eq 124 ]; then
    ...
    echo "FAIL - Script exited with error code $EXIT_CODE"
    exit 1
fi

# Test 4: Output file was created
...
# Test 5: Output file has content
